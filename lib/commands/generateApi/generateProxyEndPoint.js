  ...
  for (var apiPath in api.paths) {
    for (var resource in api.paths[apiPath]) {
      if (allowedVerbs.indexOf(resource.toUpperCase()) >= 0) {
        ...
        var flowCondition = '';
        if(apiPath === '/') {
          flowCondition = '(proxy.pathsuffix Equals &quot;' + apiPath + '&quot; or proxy.pathsuffix Equals &quot;&quot;) and (request.verb = &quot;' + resource.toUpperCase() + '&quot;)'
        } else {
          flowCondition = '(proxy.pathsuffix MatchesPath &quot;' + apiPath + '&quot; or proxy.pathsuffix MatchesPath &quot;' + apiPath + '/&quot;) and (request.verb = &quot;' + resource.toUpperCase() + '&quot;)'
        }
