...
function wrapInput (parameter) {
  ...
  if (parameter.in === 'body') {
    ...
    const pathParamValue = context.getVariable('pathParam.' + parameter.name)
    if (pathParamValue) {
